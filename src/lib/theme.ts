...
export const THEMES: Record<ThemeColor, ThemeConfig> = {
  ...
  yellow: {
    ...
    card1Icon: 'text-yellow-400',
    card1Title: 'text-yellow-600',
    card1Accent: 'text-yellow-500',
    ...
    card3: 'bg-gradient-to-br from-yellow-100/50 to-amber-200/50',
    card3Icon: 'text-orange-500',
    card3Title: 'text-orange-600',
    card3Accent: 'bg-orange-50 text-orange-500',
    card4: 'bg-gradient-to-br from-amber-100/50 to-yellow-200/50',
    card4Icon: 'text-amber-500',
    card4Title: 'text-amber-600',
    card4Accent: 'border-amber-300',
    card5: 'bg-gradient-to-br from-yellow-100/80 to-amber-200/80',
    card5Icon: 'text-amber-500',
    card5Title: 'text-amber-600',
    card5Accent: 'text-amber-400',
    card6: 'bg-gradient-to-br from-amber-100/80 to-orange-200/80',
    card6Icon: 'text-orange-500',
    card6Title: 'text-orange-600',
    skeleton1: 'bg-yellow-100',
    skeleton2: 'bg-amber-100',
    skeleton3: 'bg-yellow-100',
  ...
  rainbow: {
    ...
    headerTitle: 'rainbow-text',
    headerIcon: 'rainbow-text',
    ...
    // 카드별로 무지개 파스텔 색상: 로즈, 오렌지, 앰버, 에메랄드, 스카이, 퍼플
    ...
    card2: 'bg-gradient-to-br from-orange-50/80 to-orange-100/70',
    card2Icon: 'text-orange-400',
    card2Title: 'text-orange-600',
    card2Accent: 'bg-orange-50 text-orange-500',
    card3: 'bg-gradient-to-br from-amber-50/80 to-yellow-100/70',
    card3Icon: 'text-amber-500',
    card3Title: 'text-amber-600',
    card3Accent: 'bg-amber-50 text-amber-500',
    card4: 'bg-gradient-to-br from-emerald-50/80 to-green-100/70',
    card4Icon: 'text-emerald-500',
    card4Title: 'text-emerald-600',
    card4Accent: 'border-emerald-300',
    card5: 'bg-gradient-to-br from-sky-50/80 to-blue-100/70',
    card5Icon: 'text-sky-500',
    card5Title: 'text-sky-600',
    card5Accent: 'text-sky-400',
    card6: 'bg-gradient-to-br from-purple-50/80 to-violet-100/70',
    card6Icon: 'text-purple-500',
    card6Title: 'text-purple-600',
