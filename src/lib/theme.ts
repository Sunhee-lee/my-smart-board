...
export const THEMES: Record<ThemeColor, ThemeConfig> = {
  ...
  yellow: {
    name: '레인보우',
    bg: 'bg-gradient-to-br from-pink-50 via-yellow-50 to-sky-50',
    headerBg: 'bg-white/70',
    ...
    speechBubbleBorder: 'border-violet-100',
    speechBubbleText: 'text-violet-700',
    // 카드별로 무지개 파스텔 색상
    card1: 'bg-gradient-to-br from-rose-50/80 to-pink-100/70',
    card1Icon: 'text-rose-400',
    card1Title: 'text-rose-600',
    card1Accent: 'text-rose-500',
    card2: 'bg-gradient-to-br from-amber-50/80 to-yellow-100/70',
    card2Icon: 'text-amber-400',
    card2Title: 'text-amber-600',
    card2Accent: 'bg-amber-50 text-amber-500',
    card3: 'bg-gradient-to-br from-emerald-50/80 to-green-100/70',
    card3Icon: 'text-emerald-500',
    card3Title: 'text-emerald-600',
    card3Accent: 'bg-emerald-50 text-emerald-500',
    card4: 'bg-gradient-to-br from-sky-50/80 to-blue-100/70',
    card4Icon: 'text-sky-500',
    card4Title: 'text-sky-600',
    card4Accent: 'border-sky-300',
    card5: 'bg-gradient-to-br from-indigo-50/80 to-violet-100/70',
    card5Icon: 'text-indigo-500',
    card5Title: 'text-indigo-600',
    card5Accent: 'text-indigo-400',
    card6: 'bg-gradient-to-br from-purple-50/80 to-fuchsia-100/70',
    card6Icon: 'text-purple-500',
    card6Title: 'text-purple-600',
    skeleton1: 'bg-rose-100',
    skeleton2: 'bg-amber-100',
    skeleton3: 'bg-emerald-100',
    skeleton4: 'bg-violet-100',
    tabActive: 'bg-violet-500 text-white',
    tabInactive: 'bg-violet-50 text-violet-400 hover:bg-violet-100',
    preview: 'bg-gradient-to-br from-rose-200 via-amber-200 to-violet-200',
  },
  sky: {
    name: '스카이',
